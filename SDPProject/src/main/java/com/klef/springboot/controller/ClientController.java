...
import com.klef.springboot.service.ArticleService;
...
public class ClientController
{
  ...
  public ModelAndView addarticledemo()
  {
    ModelAndView mv = new ModelAndView("addarticle", "art",new Article());
    return mv;
  }
  ...
  public ModelAndView viewallartdemo()
  {
    ModelAndView mv = new ModelAndView("viewallarticles");
    
    List<Article> artlist = governmentService.viewallarticle();
    mv.addObject("artlist",artlist);
    
    return mv;
  }
  
  @GetMapping("/viewcallart")
  public ModelAndView viewallcartdemo()
  {
    ModelAndView mv = new ModelAndView("viewcarticles");
...
//    mv.addObject("msg", "citizen Registered Successfully");
  ...
  @PostMapping("/adarticle")
  public String adarticledemo(@ModelAttribute("art") Article article)
  {
    articleService.adarticle(article);
    
    return "redirect:viewallart";
  }
  ...
  @GetMapping("/request")
  public ModelAndView reqartbyiddemo(@RequestParam("no") int ano)
  {
    Article art = citizenService.requestarticlebyid(ano);
