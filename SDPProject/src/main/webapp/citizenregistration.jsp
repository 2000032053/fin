...
body {
  background-image: url('images/ctzn1.jpg') ;
...
<ul>
  <li><a href="/">Home</a></li>
  <li><a href="governmentlogin">government</a></li>
...
<form:form action="addcitizen" method="post" modelAttribute="ctz">
...
<td>
<form:select path="sector" required="required">
